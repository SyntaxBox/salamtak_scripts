...
switch_to_tag 2
open_terminal_run "cd ~/dev/servers/nodejs/salamtak_server_node && docker run up app_dev"
open_terminal_run "cd ~/dev/servers/nodejs/salamtak_server_node && npm run dev"

# Tag 3: Open two more terminals
switch_to_tag 3
open_terminal_run "cd ~/dev/servers/nodejs/salamtak_server_node && docker run up db"
